...
# Методы корректировки данных scripts.py:

## Запуск методов. Пример использования:

- `python manage.py shell`
- `from scripts import fix_marks, remove_chastisements, create_commendation`

## Убрать замечания на уроках

Чтобы удалить замечания Степану Анатольивичу можно воспользоваться функцией `remove_chastisements`
Пример: `remove_chastisements('Степан Анатольевич')` 

## Исправить плохие оценки на хорошие Евсеевой Марии:

Пример: `fix_marks('Евсеева Мария')` на 4 или 5

`Также можно исправить на только пять fix_marks_on_five('Васильева Мария')`

## Добавить похвальную запись Ивану Фролову по предмету история:

Пример: `create_commendation('Фролов Иван', 'История')`